  ...
  return (
    <header className="bg-white border-b border-border sticky top-0 z-50 shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
      ...
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center">
        ...
        <span className="hidden lg:block text-[0.72rem] font-extrabold text-accent bg-[rgba(27,153,139,0.1)] px-2.5 py-1 rounded-md uppercase tracking-wider mr-6 shrink-0">
          Funcionário
        </span>
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <div
            ...
            className="flex items-center gap-2 bg-surface-2 border border-border px-3 pr-4 py-1.5 rounded-full cursor-pointer transition-all hover:border-accent hover:bg-accent-light"
          >
