    ...
    <div className="mt-8 overflow-x-auto scrollbar-none -mx-4 px-4 sm:-mx-6 sm:px-6">
      <div className="flex gap-3 sm:gap-4 pb-1" style={{ minWidth: 'max-content' }}>
        {banners.map((b, i) => (
          <div
            key={i}
            className="shrink-0 w-70 sm:w-90 md:w-120 rounded-2xl p-5 sm:p-7 flex items-center justify-between gap-3 cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-xl relative overflow-hidden"
          ...
          >
            ...
            <div className="text-4xl sm:text-5xl leading-none opacity-90 shrink-0 relative z-10">
              {b.emoji}
            </div>
          </div>
        ))}
